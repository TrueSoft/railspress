    ...
    if !menu_item.post_type.blank?
      if 'nav_menu_item' == menu_item.post_type
        ...
        if 'post_type' == menu_item.type
          ...
          mi_post_obj = get_post( menu_item.object_id_ )
            if Railspress.links_to_wp
              ...
              if mi_post_obj.post_type == 'page'
                if menu_item.object_id_.to_s == get_option('page_for_posts').to_s
                  ...
                  menu_item.url = main_app.show_page_path(slug: untrailingslashit(wp_url_to_relative_url(get_permalink(mi_post_obj)).gsub(/^\//, '')))
                end
              else
