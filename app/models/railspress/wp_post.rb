module Railspress
  class WpPost < ApplicationRecord
    ...
    has_many :tags, class_name: Railspress::PostTag.name, through: :relationships, source: :taxonomy, :dependent => :destroy
    has_many :categories, class_name: Railspress::Category.name, through: :relationships, source: :taxonomy, :dependent => :destroy
    has_many :languages, class_name: Railspress::Language.name, through: :relationships, source: :taxonomy, :dependent => :destroy
    has_many :metas, class_name: Railspress::Postmeta.name, foreign_key: :post_id

    belongs_to :author, class_name: Railspress::User.name, foreign_key: :post_author

   # Stores the post object's sanitization level.
	 #
	 # Does not correspond to a DB field.
    attr_accessor :filter_str
    ...
    def first_revision
      self.parent || self # FIXME Error at parent!
    end
