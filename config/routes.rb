Railspress::Engine.routes.draw do
  ...
  if !Railspress.posts_permalink_prefix.nil?
    scope path: Railspress.posts_permalink_prefix do
      ...
      get 'page/:page' => 'railspress/home#posts', defaults: {language: I18n.default_locale.to_s}
      get ':year' => 'railspress/archive#year_archive', constraints: {year: /20[12]\d/}, defaults: {page: '1'}, as: :year_archive_posts
